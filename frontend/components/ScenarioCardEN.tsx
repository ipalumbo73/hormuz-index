...
const SCENARIO_INFO: Record<string, { label: string; labelEn: string; description: string; drivers: string; example: string; icon: string }> = {
  ...
  actual: {
    ...
    drivers: "Driven by SRI (+0.02/pt) and BSI (+0.02/pt). NOI has ZERO weight — Iran cannot use weapons it does not have. Requires extreme convergence: SRI >= 90, BSI >= 90, GAI >= 90, and DCI <= 20. DCI slows it (-0.10/pt). Nearly impossible to trigger.",
