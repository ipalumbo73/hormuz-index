...
const SCENARIO_INFO: Record<string, { label: string; labelIt: string; description: string; drivers: string; example: string; icon: string }> = {
  ...
  actual: {
    ...
    drivers: "Guidato da SRI (+0.02/pt) e BSI (+0.02/pt). NOI ha peso ZERO — l'Iran non può usare armi che non ha. Richiede convergenza estrema: SRI >= 90, BSI >= 90, GAI >= 90 e DCI <= 20. DCI frena (-0.10/pt). Scenario quasi impossibile da attivare.",
